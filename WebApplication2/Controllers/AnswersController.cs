...
namespace WebApplication2.Controllers
{
    public class AnswersController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,Code,Content,QuestionId")] Answer answer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,Code,Content,QuestionId")] Answer answer)
        {
            if (ModelState.IsValid)
            {
